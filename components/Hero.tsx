  ...
  return (
    <div className="pb-20 pt-10 md:pt-36" id="about">
      ...
      <div className="relative flex md:flex-row items-center justify-around flex-col gap-4 my-5 z-10">
        <div className="max-w-[89vw] md:max-w-3xl lg:max-w-[40vw]">
          ...
          <TextGenerateEffect
            ...
            words="Web Developer | Pursuing engineering in AI&DS in Fr. CRCE | Honors in Cyber Security | Web development Intern CodSoft | Former Intern InternPe"
          />
        </div>
      ...
      <div className="w-full flex items-center justify-center">
        <Link href="https://drive.google.com/file/d/1lBD0TLqwvLGQud9qF-5pPwOxBXD3c17a/view?usp=sharing">
